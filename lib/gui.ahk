...
myGui.Add("Text", "x96 y335 w63 h23", "回链快捷键")
hk_backlink := myGui.Add("Hotkey", "x160 y335 w155 h21", GetKey("hotkey_backlink"))
...
myGui.Add("Text", "x61 y366 w96 h27", "bookxnote快捷键:复制摘录原文")
hk_copy_content := myGui.Add("Hotkey", "x160 y368 w156 h21",app_config.HotkeyCopyContent)
hk_copy_content.OnEvent("Change", (*) => app_config.HotkeyCopyContent := hk_copy_content.Value)

myGui.Add("Text", "x61 y396 w96 h29", "bookxnote快捷键:复制外部回链")
hk_copy_backlink := myGui.Add("Hotkey", "x160 y400 w156 h21", app_config.HotkeyCopyBacklink)
hk_copy_backlink.OnEvent("Change", (*) => app_config.HotkeyCopyBacklink := hk_copy_backlink.Value)


myGui.Add("Text", "x64 y448 w93 h23 +0x200", "高亮+回链快捷键")
hotkey_hightline := myGui.Add("Hotkey", "x160 y448 w156 h21",app_config.HotkeyHightline)
...
myGui.Add("Text", "x61 y480 w96 h26", "bookxnote快捷键:设为高亮")
hotkey_bookxnote_hightline := myGui.Add("Hotkey", "x160 y480 w156 h21",app_config.HotkeyBookxnoteHightline)
